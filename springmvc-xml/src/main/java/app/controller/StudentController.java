...
public class StudentController {
	...
	public ModelAndView search(@RequestParam("name") String var) {
		logger.info("search var" + var);
		ModelAndView model = new ModelAndView("home");
		model.addObject("students", studentService.searchStudents(var));
		model.addObject("variable", var);
		return model;
	}
